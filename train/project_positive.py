...
def save_artifacts(key_values: dict, dest='model_artifacts_positive.pkl'):
...
positive_text=sample(positive_text,20000)

vocab_size = 5000
tokenizer = Tokenizer(num_words=vocab_size, lower=True)
tokenizer.fit_on_texts(positive_text)
sequences = tokenizer.texts_to_sequences(positive_text)
...
model_file = os.path.join(MODEL_DIR, 'gru_positive.h5')
